...
- **Baseline real: Regresión logística** con `class_weight="balanced"` sobre las
...
- **Desbalance de clases** (~20% de default en train, 26.5% en la validación
  out-of-time más reciente): mitigado con `class_weight` y métricas apropiadas;
  se explorará re-muestreo en la entrega final.
